...
class online_hdp:
    ...
    def new_init(self, c):
        ...
        ids = random.sample(list(range(c.num_docs)), num_samples)
        ...
        for doc in docs:
            ...
            for iter in range(5):
                ...
                self.m_lambda[:,
                              word_list] = old_lambda + sstats.m_var_beta_ss / sstats.m_batchsize
    ...
    def infer_only(self,
                   docs,
                   half_train_half_test=False,
                   split_ratio=0.9,
                   iterative_average=False):
